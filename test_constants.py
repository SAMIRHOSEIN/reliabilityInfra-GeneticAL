...
ELE_GA_POP = 128 #512#128 #80                        # Population size - (Population * Genes = 128*256) ~ (PPO frames/horizon = 5*32*1024/5 = 32768)
ELE_GA_GENS = 256# 1500 #256 #256 #200               # Number of generations - (Population * Genes = 128*256) ~ (PPO frames/horizon = 5*32*1024/5 = 32768)
...
first_pygad = "no"  # "yes" or "no"

if first_pygad == "yes":
    print("I commented some parameters and ELE_GA_CROSSOVER_PROBABILITY in pygad so that crossover is applied to every mating pair")
...
RANDOM_MUTATION_MIN_VAL=-1.0 #-0.10       # deafult = -1.0
RANDOM_MUTATION_MAX_VAL=1.0 #+0.10        # deafult = 1.0   # small β step (+0.10)
MUTATION_NUM_GENES = 1                    # 1 number of genes to mutate in a solution
...
ELE_GA_HORIZON = 35 #35 # 40 #35 40 #75
